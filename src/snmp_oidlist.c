 ...
 **********************************************************************/
void print_oid(oid *Name, long Len)
{ 
...
int oidcmp(oid *A, long ALen, oid *B, long BLen)
{
  oid *aptr = A;
  oid *bptr = B;
...
int oidncmp(oid *A, long ALen, oid *B, long BLen, long CompLen)
{
  oid *aptr = A;
  oid *bptr = B;
...
oid_ParseFn *oidlist_Find(oid *Src, long SrcLen)
{
 ...
 * 
 */
oid_ParseFn *oidlist_Next(oid *Src, long SrcLen, oid **DestP, long *DestLenP)
{
  struct MIBListEntry *Ptr;
  int ret;
  oid_ParseFn *Fn=NULL;
...
oid_ParseFn *basicGetFn(oid *Src, long SrcLen)
{
...
oid_ParseFn *basicGetNextFn(oid *Src, long SrcLen, oid **Dest, long *DestLen)
{
        oid_ParseFn *retFn=NULL;
        oid MIBRoot[]= { SYSMIB };
        int MIBRootLen=LEN_SYSMIB;
        oid MIBTail[LEN_SYSMIB+1] = { SYSMIB, 8 };
...
oid_ParseFn *sysGetFn(oid *Src, long SrcLen)
{
...
oid_ParseFn *sysGetNextFn(oid *Src, long SrcLen, oid **Dest, long *DestLen)
{
        oid MIBRoot[]= { SQ_SYS };
        int MIBRootLen=LEN_SQ_SYS;
        oid MIBTail[LEN_SQ_SYS+1] = { SQ_SYS, 2 };
        oid_ParseFn *ret;        
...
oid_ParseFn *sysFdGetFn(oid *Src, long SrcLen)
{
        debug(49,5)("sysGetFn: here! with Src[8]=%d\n",Src[8]);
        if (SrcLen == LEN_SQ_SYS+4 && Src[LEN_SQ_SYS]==SYSFDTBL)
                return snmp_sysFn;
...
oid_ParseFn *sysFdGetNextFn(oid *Src, long SrcLen, oid **Dest, long *DestLen)
{
...
oid_ParseFn *confGetFn(oid *Src, long SrcLen)
{
...
oid_ParseFn *confGetNextFn(oid *Src, long SrcLen, oid **Dest, long *DestLen)
{
        oid MIBRoot[]= { SQ_CONF };
        int MIBRootLen=LEN_SQ_CONF;
        oid MIBTail[LEN_SQ_CONF+1] = { SQ_CONF, CONF_LOG_LVL };
        oid_ParseFn *ret;        
...
oid_ParseFn *confStGetNextFn(oid *Src, long SrcLen, oid **Dest, long *DestLen)
{
        oid MIBRoot[]= { SQ_CONF, CONF_STORAGE };
        int MIBRootLen=LEN_SQ_CONF+1;
        oid MIBTail[LEN_SQ_CONF+2] = { SQ_CONF, CONF_STORAGE , CONF_ST_END-1  };
        oid_ParseFn *ret;        
...
oid_ParseFn *confTioGetNextFn(oid *Src, long SrcLen, oid **Dest, long *DestLen)
{
        oid MIBRoot[]= { SQ_CONF, CONF_TIO };
        int MIBRootLen=LEN_SQ_CONF+1;
        oid MIBTail[LEN_SQ_CONF+2] = { SQ_CONF, CONF_TIO , CONF_TIO_END-1  };
        oid_ParseFn *ret;        
...
oid_ParseFn *confPtblGetNextFn(oid *Src, long SrcLen, oid **Dest, long *DestLen)
{
        oid MIBRoot[]= { SQ_CONF, CONF_PTBL };
        int MIBRootLen=LEN_SQ_SYS+1;
        oid MIBTail[LEN_SQ_SYS+4] = { SQ_CONF, CONF_PTBL, 1, CONF_PTBL_END-1 , 0 };
	int numPeers=0;
        oid_ParseFn *ret;        

	/* XXX should be smarter than that */
	peer *p=Config.peers;
	while (p) { numPeers++; p=p->next; }
...
oid_ParseFn *prfSysGetFn(oid *Src, long SrcLen)
{
...
oid_ParseFn *prfSysGetNextFn(oid *Src, long SrcLen, oid **Dest, long *DestLen)
{
        oid MIBRoot[]= { SQ_PRF, PERF_SYS };
        int MIBRootLen=LEN_SQ_PRF+1;
        oid MIBTail[LEN_SQ_PRF+2] = { SQ_PRF, PERF_SYS , PERF_SYS_END-1 };
...
oid_ParseFn *prfProtoGetFn(oid *Src, long SrcLen)
{
        debug(49,5)("prfProtoGetFn: called with %d\n",SrcLen);

	if (SrcLen!= LEN_SQ_PRF+3)
		return NULL;
	return snmp_prfProtoFn;
}

oid_ParseFn *prfProtoGetNextFn(oid *Src, long SrcLen, oid **Dest, long *DestLen)
{
        oid MIBRoot[]= { SQ_PRF, PERF_PROTO, PERF_PROTOSTAT_AGGR, 1 };
        int MIBRootLen=LEN_SQ_PRF+2;
        oid MIBTail[LEN_SQ_PRF+3] = { SQ_PRF, PERF_PROTO, PERF_PROTOSTAT_END-1, PERF_PROTOSTAT_AGGR_END-1  };
        oid_ParseFn *ret;
...
oid_ParseFn *prfPeerGetFn(oid *Src, long SrcLen)
{
...
oid_ParseFn *prfPeerGetNextFn(oid *Src, long SrcLen, oid **Dest, long *DestLen)
{
        oid MIBRoot[]= { SQ_PRF, PERF_PEER , 1 , 1 };
        int MIBRootLen=LEN_SQ_PRF+3;
        oid MIBTail[LEN_SQ_PRF+5] = { SQ_PRF, PERF_PEER, 1, 1, PERF_PEERSTAT_END-1 , 0 };
        int numPeers=0;
        oid_ParseFn *ret;        
	peer *p;
...
oid_ParseFn *netdbGetFn(oid *Src, long SrcLen)
{
...
oid_ParseFn *netdbGetNextFn(oid *Src, long SrcLen, oid **Dest, long *DestLen)
{
        oid MIBRoot[]= { SQ_NET, NET_NETDBTBL , 1 };
        int MIBRootLen=LEN_SQ_NET+2;
        oid MIBTail[LEN_SQ_SYS+4] = { SQ_NET, NET_NETDBTBL, 1, NETDB_END-1 , 0 };
        oid_ParseFn *ret;        
	int max;
...
oid_ParseFn *dnsGetFn(oid *Src, long SrcLen)
{	
...
oid_ParseFn *dnsGetNextFn(oid *Src, long SrcLen, oid **Dest, long *DestLen)
{
        oid MIBRoot[]= { SQ_NET, NET_DNS , NET_DNS_IPCACHE,  1, 1};
        int MIBRootLen=LEN_SQ_NET+3;
        oid MIBTail[LEN_SQ_NET+5] = { SQ_NET, NET_DNS, NET_DNS_IPCACHE, 1 ,NET_IPC_END-1 , 0 };
        oid_ParseFn *ret;        
	int max;
...
oid_ParseFn *secGetFn(oid *Src, long SrcLen)
{
return NULL;
}

oid_ParseFn *secGetNextFn(oid *Src, long SrcLen, oid **Dest, long *DestLen)
{
return NULL;
}

oid_ParseFn *accGetFn(oid *Src, long SrcLen)
{
return NULL;
}

oid_ParseFn *accGetNextFn(oid *Src, long SrcLen, oid **Dest, long *DestLen)
{
return NULL;
}
