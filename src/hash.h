/* 
 *   hash.h -- Static hash table with chaining
 *
...
/* init */
void hash_init _PARAMS((int));
HashID hash_create _PARAMS((int (*)(char *, char *), int));

/* insert/delete */
int hash_insert _PARAMS((HashID, char *, void *));
int hash_delete _PARAMS((HashID, char *));
int hash_delete_link _PARAMS((HashID, hash_link *));
int hash_join _PARAMS((HashID, hash_link *));
int hash_remove_link _PARAMS((HashID, hash_link *));

/* searching, accessing */
hash_link *hash_lookup _PARAMS((HashID, char *));
hash_link *hash_first _PARAMS((HashID));
hash_link *hash_next _PARAMS((HashID));
hash_link *hash_get_bucket _PARAMS((HashID, unsigned int));
